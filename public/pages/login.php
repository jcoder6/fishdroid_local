   ...
   <div class="flex relative">
      <div class="login-container w-3/5 flex flex-col">
         ...
         <div class="form-container self-center mt-16 w-1/2 p-10 border border-gray-400 rounded-md drop-shadow">
            ...
            <form class="flex flex-col" action="/dashboard" method="post">
               ...
               <button type="submit" class="bg-blue-700 rounded-md p-2 border border-blue-700 text-white text-sm hover:bg-white hover:text-blue-700 hover:border-blue-700 hover:border transition-all cursor-pointer mb-2">Log in</button>
