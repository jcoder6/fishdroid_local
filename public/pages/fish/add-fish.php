         ...
         <form class="pb-6 upload-form text-right" action="/fishes/save" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               ...
               <div class="family_name w-[50%]">
                  ...
                  <datalist id="options">
                     ...
                     <option data-value="<?= $familyName->getId() ?>"><?= ucfirst(strtolower($familyName->getFamily_name())) ?></option>
                     <?php endforeach;?>  
                  </datalist>
               </div>
            ...
            <div class="ml-10 mt-6">
               <div class="image-label flex items-center gap-3">
                  ...
                  <label for="eventPhoto" class=" font-semibold text-[13px] cursor-pointer shadow-md text-green-600 py-1 px-4 rounded-md hover:text-white bg-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600  transition-all"><i class="fa-solid fa-upload mr-3  "></i>Upload</label>
               </div>
