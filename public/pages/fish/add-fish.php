...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
      ...
      <h4 class="text-xl font-bold text-green-600 p-3 pl-10 pt-6">Add Fish</h4>
         <form class="pb-6 upload-form text-right" action="/fishes/save" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               <div class="fish_name w-[50%]">
                  ...
                  <input type="text" name="fish_name" id="fish_name" placeholder="Enter fish name" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
               ...
               <label for="scientific_name" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Scientific name <span class="text-red-500 font-bold">*</span></label>
                  <input type="text" name="scientific_name" id="scientific_name" placeholder="Enter scientific name" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
            </div>
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               ...
               <label for="life_span" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Local Name<span class="text-red-500 font-bold"> *</span></label>
                  <input type="text" name="life_span" id="life_span" placeholder="Enter local name" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
               <div class="family_name w-[50%]">
                  ...
                  <input type="text" placeholder="Select the family name" autocomplete="off" id="family_name" name="family_name" list="options" class="select-family-name bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
                  <datalist id="options">
            ...
            <div class="ml-10 mt-6">
               <div class="image-label flex items-center gap-3">
                  ...
                  <label for="eventPhoto" class=" font-semibold text-[13px] cursor-pointer text-green-600 py-1 px-4 rounded-md hover:text-white bg-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600  transition-all"><i class="fa-solid fa-upload mr-3  "></i>Upload Photo</label>
               </div>
               <input type="file" name="fish_image" id="eventPhoto" class="hidden" onChange="previewChoosenImage(event)">
               <div id="inputPhoto" class="relative h-52 w-96 border mb-5 bg-white border-slate-400 overflow-hidden rounded-md text-slate-400 flex justify-center text-xs items-center mt-6">No Image Choose</div>
            ...
            <input type="submit" value="Add fish" class="mr-10 transition-all font-semibold text-green-600 text-[13px] shadow-md py-1 rounded-md w-[8rem] cursor-pointer bg-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:text-white">
      </form>
