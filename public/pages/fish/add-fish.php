...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
      ...
      <h4 class="text-xl font-bold text-blue-700 p-3">Add User</h4>
         <form class="pb-6 upload-form text-right" action="/users/save" method="post" enctype="multipart/form-data">

            <div class="flex justify-between py-3 gap-3 px-10">
               <div class="fullname w-[50%]">
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               <div class="username w-[50%]">
                  <label for="username" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Family name</label>
                  <input type="text" name="username" id="username" placeholder="Enter family name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
               <div class="password w-[50%]">
               <label for="password" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Life span</label>
                  <input type="password" name="password" id="password" placeholder="Enter life span" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
            </div>
            ...
            <div class="flex justify-between py-3 px-10">
               <div class="username w-[100%]">
                  <label for="username" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Fish Information</label>
                  <textarea type="text" name="username" id="username" placeholder="Enter a description or some information about the fish..." class="bg-gray-50 block border min-h-[20rem] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3"></textarea>
               </div>
