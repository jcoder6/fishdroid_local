         ...
         <form class="pb-6 upload-form text-right" action="/users/save" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between py-3 px-10">
               <div class="username w-[100%]">
                  ...
                  <textarea type="text" name="username" id="eventDesc" placeholder="Enter a description or some information about the fish..." class="bg-gray-50 block border min-h-[20rem] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3"></textarea>
               </div>
