               ...
               <div class="gender_selection w-[50%]">
                  ...
                  <div class="flex gap-3">
                     <label for="true-edible" class="flex items-center text-xs">
                        <input type="radio" id="true-edible" name="is_edible" value="1" class="mr-2" <?= $fish->getIs_edible() > 0 ? 'checked' : '' ?>>
                        YES
                     </label>
                     <label for="false-edible" class="flex items-center text-xs">
                        <input type="radio" id="false-edible" name="is_edible" value="0" class="mr-2" <?= $fish->getIs_edible() > 0 ? '' : 'checked' ?>>
                        NO
                     </label>
                  </div>
               </div>
               ...
               <div class="gender_selection w-[50%]">
                  ...
                  <div class="flex gap-3">
                     <label for="true-pet" class="flex items-center text-xs">
                        <input type="radio" id="true-pet" name="is_pettable" value="1" class="mr-2" <?= $fish->getIs_pettable() > 0 ? 'checked' : '' ?>>
                        YES
                     </label>
                     <label for="false-pet" class="flex items-center text-xs">
                        <input type="radio" id="false-pet" name="is_pettable" value="0" class="mr-2" <?= $fish->getIs_pettable() > 0 ? '' : 'checked' ?>>
                        NO
                     </label>
                  </div>
               </div>
...
<?php 
   ...
   function getFamilyName($id, $familyNames){
      ...
      echo ucfirst(strtolower($familyName));
   }
?>
