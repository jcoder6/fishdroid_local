         ...
         <form class="pb-6 upload-form text-right" action="/fishes/update/<?= $fish->getId() ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               <div class="fish_name w-[50%]">
                  ...
                  <input type="text" value="<?= $fish->getFish_name() ?>" name="fish_name" id="fish_name" placeholder="Enter fish name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
               ...
               <label for="scientific_name" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Scientific name</label>
                  <input type="text" value="<?= $fish->getScientific_name() ?>" name="scientific_name" id="scientific_name" placeholder="Enter scientific name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
            </div>
            ...
            <div class="flex justify-between py-3 gap-3 px-10">
               ...
               <label for="life_span" class="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-white">Life span</label>
                  <input type="text" value="<?= $fish->getLife_span() ?>" name="life_span" id="life_span" placeholder="Enter life span" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
               </div>
            </div>
            ...
            <input type="submit" value="Update fish" class="border mr-10 border-blue-700 bg-blue-700 transition-all font-semibold text-white py-1 rounded-md w-[8rem] cursor-pointer hover:bg-white hover:text-blue-700">
        </form>
