...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
    ...
    <div class="contents-container w-[60%] mt-[-60px] bg-slate-200 mx-auto rounded-lg min-h-[90vh] shadow-lg">
        ...
        <form action="/familyNames/save" method="post">
            <div class="add-family-name bg-gradient-to-bl from-green-400 via-green-500 to-green-600 p-2 flex justify-center gap-2 items-center text-center mt-5">
                <label for="family_name" class="text-left text-sm font-bold text-slate-100">Add Family Name:</label>
                <input type="text" name="family_name" placeholder="Enter Family Name" id="family_name" class="bg-slate-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 px-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ml-3 w-[40%]" required>
        ...
        <div class="manage-header bg-gray-700 flex justify-between items-center px-4 py-2">
            <p class="manage-header-title font-bold text-slate-200 text-lg">Family name list</p>
        </div>
        ...
        <div class="fish-table border-b border-b-gray-400 bg-slate-100 flex justify-between px-5 py-1">
            ...
            <div class="text-gray-800 flex items-center justify-center font-semibold fish-name w-[60%]"><?=$familyName->getFamily_name()?></div>
            <div class="text-blue-700 flex gap-3 items-center justify-center font-semibold text-center action w-[30%]">
