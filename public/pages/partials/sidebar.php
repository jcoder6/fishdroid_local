<div class="sidebar bg-slate-100 shadow-2xl w-48 h-screen">

   <div class="logo flex items-center pt-2">
   ...
   <div class="divider h-1 w-full bg-gradient-to-r from-blue-500 to-cyan-500 shadow-md"></div>
