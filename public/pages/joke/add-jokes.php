   ...
   <div class="contents-container w-[40%] mt-[-60px] bg-slate-100 mx-auto rounded-lg">
      ...
      <form class="upload-form text-right pb-6" action="/jokes/save" method="post" enctype="multipart/form-data">
         ...
         <div  id="input_image_cont" class="block px-10 py-3">
            ...
            <div id="inputPhoto" class="relative h-52 w-[100%] border mb-5 bg-white border-slate-400 overflow-hidden rounded-md text-slate-400 flex justify-center text-xs items-center mt-2">No Image Choose</div>
