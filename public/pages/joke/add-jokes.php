...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-[40%] mt-[-60px] bg-slate-200 mx-auto rounded-lg">
      <h4 class="text-xl font-bold text-blue-700 p-3">Add Trivia</h4>
      <form class="upload-form text-right pb-6" action="/jokes/save" method="post" enctype="multipart/form-data">
         ...
         <div class="py-3 px-10">
               <div class="w-[100%]">
                  ...
                  <input type="text" class="hidden" name="default_video" value="NO_VIDEO_YET" />
         ...
         <div class="flex justify-between py-3 px-10">
            <div class="username w-[100%]">
               ...
               <textarea required type="text" name="trivia" id="trivia" placeholder="Description..." class="bg-gray-50 block border min-h-[20rem] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3"></textarea>
            </div>
         
         </div>      
         <input type="submit" value="Add Trivia" class="border mr-10 border-blue-700 transition-all font-semibold text-blue-700 py-1 rounded-md w-[8rem] cursor-pointer bg-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 hover:text-white">
      </form>
