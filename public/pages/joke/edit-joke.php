...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-[40%] mt-[-60px] bg-slate-200 mx-auto rounded-lg">
      <h4 class="text-xl font-bold text-blue-700 p-3">Edit Triva</h4>
      <form class="upload-form text-right pb-6" action="/jokes/update/<?= $trivia->getId() ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="submit" value="Update trivia" class="border mr-10 border-blue-700 transition-all font-semibold text-blue-700 py-1 rounded-md w-[8rem] cursor-pointer bg-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 hover:text-white">
      </form>
