...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
      ...
      <div class="contents-container w-[70%] mt-[-60px] bg-slate-100 mx-auto rounded-lg">
         ...
         <div class="fish-table border-b border-b-gray-400 bg-slate-100 flex px-5 py-1">
            ...
            <div class="text-gray-800 flex ml-10 items-center font-semibold fish-name w-[72%]"><?= $trivia->getTrivia() ?></div>
        ...
        <div class="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
          <div class="flex flex-col justify-center items-center">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete this joke?</h3>
            </div>
          </div>
        </div>
