...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-[40%] mt-[-60px] bg-slate-100 mx-auto rounded-lg">
      <h4 class="text-xl font-bold text-green-600 p-3 pl-10 pt-6">Edit Quiz</h4>
      <form class="upload-form text-right pb-10" action="/quizzes/update/<?= $quiz->getId(); ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="submit" value="Update Quiz" class="mr-10 transition-all font-semibold text-[13px] text-green-600 shadow-md py-1 rounded-md w-[8rem] cursor-pointer bg-white  hover:text-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600">
      </form>
