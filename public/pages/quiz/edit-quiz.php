      ...
      <form class="upload-form text-right pb-10" action="/quizzes/update/<?= $quiz->getId(); ?>" method="post" enctype="multipart/form-data">
         <div class="px-10 h-[100%]">
            ...
            <div class="fullname w-[100%] mt-5">
               ...
               <input type="text" name="quiz_answer" id="quiz_answer" value="<?= $quiz->getQuiz_answer() ?>" placeholder="Enter fish name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
            </div>
            <div class="email w-[100%]">
               ...
               <textarea type="text" name="quiz_hint" id="quiz_hint" placeholder="Write a hint about the answer" class="bg-gray-50 block border min-h-[5rem] border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3"><?= $quiz->getQuiz_hint() ?></textarea>
            </div>
            
         </div>
            
         <input type="submit" value="Update Quiz" class="border mr-10 mt-5 border-blue-700 transition-all font-semibold text-blue-700 py-1 rounded-md px-3 cursor-pointer bg-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 hover:text-white">
      </form>
