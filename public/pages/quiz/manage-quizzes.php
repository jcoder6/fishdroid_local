...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-full mt-[-56px] bg-slate-100 mx-auto min-h-[90vh]">
      <h4 class="text-xl font-bold text-green-600 p-3 text-center">Manage Game Question</h4>
      <div class="manage-header bg-gradient-to-l from-green-400 via-green-500 to-green-600 flex justify-between items-center px-4 py-2">
         <p class="manage-header-title font-bold text-slate-100 text-lg">Game Question List</p>
         <a href="/quizzes/create" class="bg-white hover:bg-gradient-to-tr from-teal-400 via-teal-500 to-teal-600 rounded-md font-semibold hover:text-white pr-3 pl-2 py-1 transition-all text-green-600 text-sm"><i class="fa-solid fa-plus pr-2"></i>Add Game</a>
      </div>
      <div class="bg-slate-300 flex px-5 py-1">
         <div class="text-center text-gray-700 font-semibold no w-[3%]">No</div>
         <div class="text-center text-gray-700 font-semibold fish-name w-[35%]">Game Image</div>
         <div class="text-center text-gray-700 font-semibold img w-[35%]">Game Answer</div>
      ...
      <div class="fish-table border-b border-b-gray-400 bg-slate-100 flex px-5 py-1">
         ...
         <div class="text-gray-800 flex justify-center items-center fish-name w-[35%]">
            <div class="fish-image-container w-[20%] h-[50px] overflow-hidden relative">
