...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
      ...
      <h4 class="text-xl font-bold text-green-600 p-3 pl-10 pt-6">Add User</h4>
         <form class="upload-form text-right pb-12" action="/users/save" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" value="Add user" class="mr-10 transition-all font-semibold text-green-600 text-[13px]  shadow-md py-1 rounded-md w-[8rem] cursor-pointer bg-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:text-white">
         </form>
