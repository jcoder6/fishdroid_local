...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
    ...
    <div class="contents-container w-full mt-[-56px] bg-slate-100 mx-auto min-h-[90vh]">
        ...
        <form action="/fishnutritions/save" method="post">
            <div class="add-family-name bg-gray-700 p-2 flex justify-center gap-2 items-center text-center mt-5">
                ...
                <input type="text" name="nutrition" placeholder="Enter Nutrition" id="nutrition" class="bg-slate-100 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 px-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ml-3 w-[40%]" required>
        ...
        <div class="bg-slate-300 flex justify-between px-5 py-1">
            ...
            <div class="text-gray-700 font-semibold text-center fish-name w-[65%]">Nutrition</div>
        ...
        <div class="fish-table border-b border-b-gray-400 bg-slate-100 flex justify-between px-5 py-1">
            ...
            <div class="text-gray-800 flex items-center justify-center fish-name w-[65%]"><?= ucfirst(strtolower($fishNutrition->getNutrition_name())) ?></div>
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <div class="bg-gray-50 px-4 py-4 flex justify-center items center gap-3">
                    <a href="/fishnutritions/delete/<?=$id?>" type="button" class="min-w-[30%] transition-all rounded-md text-center bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500">Delete</a>
                    <a href="/fishnutritions" type="button" class="min-w-[30%] transition-all rounded-md text-center bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Cancel</a>
                </div>
            </div>
        </div>
    </div>
