...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
  <div class="bg-slate-100 p-8 w-[60%] m-auto min-h-[90vh] mt-5  rounded-lg shadow-md mb-10">
    ...
    <div class="msg-content mt-5 mb-3 bg-slate-200 leading-8 p-4 border border-gray-300 rounded-md text-gray-700 min-h-[30rem]">
    <?= $message->getMessage() ?>
    </div>
