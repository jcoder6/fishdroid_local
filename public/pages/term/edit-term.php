...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-[60%] mt-[-60px] bg-slate-200 mx-auto rounded-lg min-h-[90vh]">
      <h4 class="text-xl font-bold text-blue-700 p-3">Update Term</h4>
      <form class="upload-form text-right" action="/terms/update/<?=$term->getId()?>" method="post" enctype="multipart/form-data">
         ...
         <div class="flex justify-between py-3 px-10">
            <div class="fullname w-[100%]">
               ...
               <input required type="text" name="tech_term" id="tech_term" value="<?=$term->getTech_term()?>" placeholder="Enter Technological Term" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-3">
            </div>
         </div>
         ...
         <div class="ml-10 mt-6">
               ...
               <input type="hidden" name="default_img" value="<?= $term->getTerm_img(); ?>">
            </div>
