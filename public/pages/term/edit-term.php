...
<div class="admin-feature-container w-full h-screen overflow-auto px-3">
   ...
   <div class="contents-container w-[50%] mt-[-60px] bg-slate-100 mx-auto rounded-lg min-h-[90vh]">
      ...
      <form class="upload-form text-right pb-10" action="/terms/update/<?=$term->getId()?>" method="post" enctype="multipart/form-data">
         ...
         <input type="submit" value="Update" class="mr-10 transition-all font-semibold text-[13px] text-green-600 shadow-md py-1 rounded-md p-5 cursor-pointer bg-white h hover:text-white hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600 ">
      </form>
